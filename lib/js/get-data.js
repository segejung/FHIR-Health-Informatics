...
FHIR.oauth2.ready().then(function(client) {
    ...
    client.request("Observation?" + query, {
        ...
        function (ob) {
            ...
            p.nagler = (((height[0].valueQuantity.value - 152.4)/(2.54)) * 0.9 + 45) * 1.1 + ' ' + height[0].valueQuantity.unit;
            ...
            function displayBmiAnalysis() {
                if (p.bmi < 18.5) {
                    ...
                    bmi_analysis.innerHTML = "Obesity";
                }
            ...
            function displayNagler() {
                nagler_formula.innerHTML = "Recommended weight for your height is" + p.nagler.value;
                nagler_formula2.innerHTML = "You are " + (weight[0].valueQuantity.value - p.nagler.value) + "over.";
    ...
    function getCurrentStr() {
        ...
        var zone = d.toString().split(" ")[5].substring(3, 6) + ":00"

        return year + "-" + pad(month) + "-" + pad(date) + "T" + pad(hour) + ":" + pad(minute) + ":" + zone;
    }
    ...
    function addWeightAnnotation() {
        ...
        if (annotation != "") {
            ...
            var msg = annotation + "(author: ss, time: " + now + ")";
            client.update(weightObservation).then(function () {
                displayAnnotation(msg);
            });
        }
    }
