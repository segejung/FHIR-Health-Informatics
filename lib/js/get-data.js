...
function displayAnalysis(anyls) {
    cholesterol.innerHTML = anyls.cholesterol;
    bmi_analysis.innerHTML = anyls.bmi_analysis;
    bp_analysis.innerHTML = anyls.bp_analysis;
...
FHIR.oauth2.ready().then(function(client) {
    ...
    client.request("Observation?" + query, {
        ...
        function (ob) {
            ...
            p.hdl = hdl;
            p.ldl = ldl;
            p.bmi = weight/(0.01*height)^2; //BMI calculator
...
//helper function to display the bmi on the index page
    function displayBmi(bmi_calc) {
        bmi_calc =  weight/(0.01*height)^2;
        bmi.innerHTML = bmi_calc;
