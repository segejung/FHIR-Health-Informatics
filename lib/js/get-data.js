    ...
    client.request("Observation?" + query, {
        ...
        function (ob) {
            ...
            function displaySysAnalysis() {
                if (systolicbp.valueQuantity.value < 120) {
                    sys_ana.innerHTML = "Normal";
                } else if (systolicbp.valueQuantity.value > 120 && systolicbp.valueQuantity.value < 130) {
                    sys_ana.innerHTML = "Elevated";
                } else if (systolicbp.valueQuantity.value > 130 && systolicbp.valueQuantity.value < 140) {
                    sys_ana.innerHTML = "High Blood Pressure Stage 1";
                } else if (systolicbp.valueQuantity.value > 140 && systolicbp.valueQuantity.value < 180) {
                    sys_ana.innerHTML = "High Blood Pressure Stage 2";
                } else if (systolicbp.valueQuantity.value > 180) {
            ...
            function displayDiaAnalysis() {
                if (diastolicbp.valueQuantity.value < 80) {
                    dia_ana.innerHTML = "Normal";
                } else if (diastolicbp.valueQuantity.value > 80 && diastolicbp.valueQuantity.value < 90) {
                    dia_ana.innerHTML = "High Blood Pressure Stage 1";
                } else if (diastolicbp.valueQuantity.value > 90 && diastolicbp.valueQuantity.value < 120) {
                    dia_ana.innerHTML = "High Blood Pressure Stage 2";
                } else if (diastolicbp.valueQuantity.value > 120) {
