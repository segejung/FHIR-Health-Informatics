    ...
    client.request("Observation?" + query, {
        ...
        function (ob) {
            ...
            function displaySysAnalysis() {
                if (sys[0].valueQuantity.value < 120) {
                    sys_ana.innerHTML = "Normal";
                } else if (sys[0].valueQuantity.value > 120 && sys[0].valueQuantity.value < 130) {
                    sys_ana.innerHTML = "Elevated";
                } else if (sys[0].valueQuantity.value > 130 && sys[0].valueQuantity.value < 140) {
                    sys_ana.innerHTML = "High Blood Pressure Stage 1";
                } else if (sys[0].valueQuantity.value > 140 && sys[0].valueQuantity.value < 180) {
                    sys_ana.innerHTML = "High Blood Pressure Stage 2";
                } else if (sys[0].valueQuantity.value > 180) {
            ...
            function displayDiaAnalysis() {
                if (dia[0].valueQuantity.value < 80) {
                    dia_ana.innerHTML = "Normal";
                } else if (dia[0].valueQuantity.value > 80 && dia[0].valueQuantity.value < 90) {
                    dia_ana.innerHTML = "High Blood Pressure Stage 1";
                } else if (dia[0].valueQuantity.value > 90 && dia[0].valueQuantity.value < 120) {
                    dia_ana.innerHTML = "High Blood Pressure Stage 2";
                } else if (dia[0].valueQuantity.value > 120) {
                    dia_ana.innerHTML = "Hypertensive Crisis";
                }
                dia_ana.innerHTML = dia[0].valueQuantity.value;
            }
            displayDiaAnalysis();
