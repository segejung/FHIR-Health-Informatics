    ...
    client.request("Observation?" + query, {
        ...
        function (ob) {
            ...
            function displaySysAnalysis() {
                if (systolicbp[0].valueQuantity.value < 120) {
                    sys_ana.innerHTML = "Normal";
                } else if (systolicbp[0].valueQuantity.value > 120 && systolicbp[0].valueQuantity.value < 130) {
                    sys_ana.innerHTML = "Elevated";
                } else if (systolicbp[0].valueQuantity.value > 130 && systolicbp[0].valueQuantity.value < 140) {
                    sys_ana.innerHTML = "High Blood Pressure Stage 1";
                } else if (systolicbp[0].valueQuantity.value > 140 && systolicbp[0].valueQuantity.value < 180) {
                    sys_ana.innerHTML = "High Blood Pressure Stage 2";
                } else if (systolicbp[0].valueQuantity.value > 180) {
            ...
            function displayDiaAnalysis() {
                if (diastolicbp[0].valueQuantity.value < 80) {
                    dia_ana.innerHTML = "Normal";
                } else if (diastolicbp[0].valueQuantity.value > 80 && diastolicbp[0].valueQuantity.value < 90) {
                    dia_ana.innerHTML = "High Blood Pressure Stage 1";
                } else if (diastolicbp[0].valueQuantity.value > 90 && diastolicbp[0].valueQuantity.value < 120) {
                    dia_ana.innerHTML = "High Blood Pressure Stage 2";
                } else if (diastolicbp[0].valueQuantity.value > 120) {
